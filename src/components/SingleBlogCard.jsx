...
const SingleBlogCard = ({params = {}}) => {
  ...
  return (
    <div className="card bg-base-100 w-3/5 shadow-xl container mx-auto my-10">
      <Image
      ...
      <div className="card-body items-center text-center">
        <h2 className="card-title">{post?.title || "Blog Title"}</h2>
        <p className="text-justify">
          {post?.description || "Blog description goes here."}
        </p>
