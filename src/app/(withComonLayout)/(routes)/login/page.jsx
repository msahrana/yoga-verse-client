...
const Login = () => {
  ...
  return (
    <div className="w-full max-w-md p-8 space-y-3 rounded-xl border-2 container mx-auto my-3 md:mt-[38px] mb-64">
      ...
      <p className="text-xs text-center sm:px-6 dark:text-gray-600">
        ...
        <Link
          href="/register"
          className="underline text-blue-400 font-bold ml-1"
        >
          Sign up
        </Link>
      </p>
